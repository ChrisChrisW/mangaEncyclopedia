...
import { ListPage, ListGenre } from "../functions/Liste"; // Appel des listes de piker
import { switchType } from "../functions/SwitchFunction";

import { Article } from "../functions/Article"; // Mise en page d'Article

export default function GenreMangaAPI({ navigation }) {
  ...
  const [search, setSearch] = useState("adventure"); // La recherche en string
    ...
    return (
      <View style={styles.container}>
        ...
        <PickerSelect
          ...
          onValueChange={(value) =>
            SelectGenre(value, setSearch, setPage, setFirstPage, setLastPage)
          }
          value={search}
          items={ListGenre()}
